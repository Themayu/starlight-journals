...
A Foundry VTT system module for *Starlight Journals* by Ian P. Quinlan.

## System Installation

This software is not yet packaged for installation into Foundry VTT by the
developers, and must be compiled from source.
